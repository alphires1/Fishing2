...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.bgLabel.setGeometry(QtCore.QRect(2, 0, 711, 400))
        ...
        self.start_button.setGeometry(QtCore.QRect(320, 270, 75, 30))
        self.start_button.setAutoDefault(False)
        self.start_button.setObjectName("start_button")
        self.stop_button = QtWidgets.QPushButton(parent=Form)
        self.stop_button.setEnabled(False)
        self.stop_button.setGeometry(QtCore.QRect(320, 330, 75, 30))
        ...
        self.setting_toolButton.setGeometry(QtCore.QRect(685, 30, 31, 31))
        icon1 = QtGui.QIcon()
...
"\n"
"----------------------------------------------------------"))
        self.setting_toolButton.setText(_translate("Form", "..."))
